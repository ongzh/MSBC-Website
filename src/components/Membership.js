...
function Membership(){
    ...
    <br/>
    <p style={{fontFamily: "Georgia, serif", fontSize: "20px", textAlign: "center", color: "black"}}>Before you attend your first training session, please fill up the following <a href={interestForm}> interest form</a> as well as this year's <a href={waiver}>waiver form</a> and send it in to mcgillboxingclub@ssmu.ca
    </p>

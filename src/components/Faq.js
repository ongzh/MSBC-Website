...
function Faq(){
    return <div id="faq">
        ...
        <p>Beginners are most definitely welcome! Most people who have joined have little to no experience with boxing.</p>
        <h4>
            Do you offer free trials?
        </h4>
        <p>The first two classes are free. After which you can choose to pay either by the semester or by the year.</p>
        <h4>
        ...
        <h4>
            Do I show have to show up to both training sessions per week?
        </h4>
        <p>You can show up whenever you like. However, staying commited and training regh4arly is the fastest way to improve!</p>
        <h4>
            I can only show up to one session per week, can I get a discount in my membership fees?
        </h4>
        <p>Unfortunately, to remain fair to all our members, we cannot give a discount in membership.</p>
        <h4>
            If i submitted the waiver last academic year, do I have to resubmit it again?
        </h4>

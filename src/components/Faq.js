function Faq(){
    return <div id="faq" style={{padding: "5%", backgroundImage:"linear-gradient(rgb(33, 33, 33),rgb(0,0,0))"}}>
        <h1 style={{fontFamily: "Georgia, serif", fontSize: "calc(20px + 3vw)", textAlign: "center", color: "red"}}>Frequently Asked Questions</h1>
        <br/>
        <ul style = {{fontSize: "30px"}}>
            <li>How do i join the club?</li>
        </ul>
        <p >Simply show up to one of our training sessions and approach our friendly execs.</p>
        <ul style = {{fontSize: "30px"}}>
        ...
        <ul style = {{fontSize: "30px"}}>
            <li>Do you offer free trials?</li>
        </ul>

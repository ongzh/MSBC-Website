...
function Navigationbar() {
    return <div style={{fontFamily: "Georgia, serif"}}>
        <ScrollspyNav offset={-20} scrollTargetIds={["about", "schedule", "team", "waiver","faq"]} activeNavClass="active" scrollDuration="100">
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="ms-auto">
                            ...
                            <Nav.Link href="#membership"><h3>Membership</h3></Nav.Link>
